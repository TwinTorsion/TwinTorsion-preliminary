...
<svelte:head>
    <title>Dashboard | TwinTorsion Editor</title>
</svelte:head>
<div class="screen">
    <Header />
        ...
        <div class="resources-cont">
            <div class="title-cont">
                <span class="title">
                    <h2>Resources:</h2>
                    <p class="sub-title">
                        Here you can find the resources to help you get started with TwinTorsion Editor.
                    </p>
                </span>
            </div>
            <div class="resources-list">
                <ResourceTile
                    name="User Guide"
                    link="https://github.com/TwinTorsion/TwinTorsion-preliminary/wiki/User-Guide"
                ...
                <ResourceTile
                    name="Developer Docs"
                    link="https://github.com/TwinTorsion/TwinTorsion-preliminary/wiki/Developer-Docs"
                ...
                <ResourceTile
                    name="GitHub"
                    link="https://github.com/TwinTorsion/TwinTorsion-preliminary"
